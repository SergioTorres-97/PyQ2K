...
def main():
    calibrador = Calibracion(
        filepath=config_vargas['filepath'],
        header_dict=config_vargas['header_dict'],
        parametros=parametros_vargas,
        q_cabecera=config_vargas['q_cabecera'],
